...
You'll want to do a find-and-replace to replace all instances of ``custom-mfe`` with the name of your new repository.  Also edit index.html to replace "Application Template" with a friendly name for this application that users will see in their browser tab.
...
In the following steps, replace "custom-mfe' with the name of the repo you created when copying this template above.

1. Clone your new repo:

  ``git clone https://github.com/openedx/custom-mfe.git``
...
The source for this project is organized into nested submodules according to the ADR `Feature-based Application Organization <https://github.com/openedx/custom-mfe/blob/master/docs/decisions/0002-feature-based-application-organization.rst>`_.
...
.. |Build Status| image:: https://api.travis-ci.com/edx/custom-mfe.svg?branch=master
   :target: https://travis-ci.com/edx/custom-mfe
.. |Codecov| image:: https://codecov.io/gh/edx/custom-mfe/branch/master/graph/badge.svg
   :target: https://codecov.io/gh/edx/custom-mfe
.. |license| image:: https://img.shields.io/npm/l/@edx/custom-mfe.svg
   :target: @edx/custom-mfe
